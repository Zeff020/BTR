...
Due to their equivalence, whatever we can prove with the one diagram we can state as fact for the other without needing to prove it for the other. This can be very convenient in security proofs.
