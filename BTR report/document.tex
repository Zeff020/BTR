...
%The critique that we can give to this method also depends on the role that it takes up. For example, if we were to assume that the purpose of the diagrammatic method is to quickly draft ideas for security proofs intuitively, it would be not be fair critique to say that it is not extensive enough since we do not require this from a method with the purpose of drafting up proofs. 
